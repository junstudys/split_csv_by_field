...
DATE_FORMATS = {
    ...
    # 时分（无秒），月份日期补零
    'yyyy/MM/dd HH:mm': r'^\d{4}/(0[1-9]|1[0-2])/(0[1-9]|[12][0-9]|3[01])\s+([01][0-9]|2[0-3]):[0-5][0-9]$',
    'yyyy-MM-dd HH:mm': r'^\d{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])\s+([01][0-9]|2[0-3]):[0-5][0-9]$',

    # 时分秒，月份日期不补零（新增）
    'yyyy/M/d HH:mm:ss': r'^\d{4}/\d{1,2}/\d{1,2}\s+\d{1,2}:\d{2}:\d{2}$',
    'yyyy-M-d HH:mm:ss': r'^\d{4}-\d{1,2}-\d{1,2}\s+\d{1,2}:\d{2}:\d{2}$',

    # 时分（无秒），月份日期不补零（新增）
    'yyyy/M/d HH:mm': r'^\d{4}/\d{1,2}/\d{1,2}\s+\d{1,2}:\d{2}$',
    'yyyy-M-d HH:mm': r'^\d{4}-\d{1,2}-\d{1,2}\s+\d{1,2}:\d{2}$',
